...
app.post('/persona', function (req, res, next) { //cambiar "function" por "async", sacar "next"
    try {
        ...
        */
        ...
        respuesta = query(query, [req.body.nombre.toUpperCase(), req.body.apellido.toUpperCase(), req.body.email.toUpperCase(), req.body.alias.toUpperCase());
...
app.get ('/persona', function (req, res, next)) { //cambiar "function" por "async", sacar "next"
    try {
...
/* TODO LO QUE SIGUE EN LAS PROXIMAS LINEAS CORRESPONDE AL EJEMPLO PRESENTADO POR LA PROFESORA EN EL TP4 DEL MOD3
